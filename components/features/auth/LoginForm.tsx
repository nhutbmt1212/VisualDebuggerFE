    ...
    return (
        <div className="w-full">
            <div className="text-center md:text-left mb-8">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base">Log in to your account to continue.</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="space-y-1.5 text-left">
                    <div className="flex justify-between items-center">
                        ...
                        <Link className="text-xs text-purple-600 dark:text-purple-400 font-medium hover:underline" href="/forgot-password">Forgot Password?</Link>
                    </div>
